...
def generate_prompts_for_sentences(sentences):
    ...
    prompt_examples = [
        {
            "input": "In the sprawling metropolis of Zenith Prime, neon lights pulsed against the backdrop of a star-studded void, illuminating the shadows of a city teetering on the edge of chaos.",
...
if __name__ == "__main__":
    ...
    sentences_with_prompts = generate_prompts_for_sentences(story_data.get("sentences", {}))
