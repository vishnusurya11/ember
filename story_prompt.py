...
def split_story_into_sentences(story):
    ...
    for i, sentence in enumerate(sentences, start=1):
        key = f"{i:03}"  # Incremental key with leading zeros (e.g., 001, 002, etc.)
