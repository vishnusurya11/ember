...
if __name__ == "__main__":
    # Replace with your actual input directory
    input_directory = r"D:\langchain\Ember\input"
    random_selection = pick_random_topic(input_directory)
    print(
        f"Randomly selected topic: {random_selection['topic']}, Type: {random_selection['type']}"
    )
