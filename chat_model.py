...
def generate_short_script(input_dict):
    ...
    dinosaur_examples = [{"input": "Tyrannosaurus Rex",
    ...
    space_object_examples = [{"input": "Mars",
    ...
    water_beings_examples = [{"input": "Great White Shark",
    ...
    country_final_prompt = ChatPromptTemplate.from_messages(
        [
            ...
            ("human",
             f"Tell me about {input_dict['topic']}?"),
        ])
