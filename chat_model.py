...
def generate_short_script(input_dict):
    ...
    {"input": "Halley's Comet", "output": """Halley's Comet is the most famous comet, visible from Earth every 75-76 years. It has a highly elliptical orbit that takes it far beyond Neptune before swinging back toward the Sun. The comet is composed of ice, dust, and gas, creating a bright coma and tail when it approaches the Sun. Fun fact: Halley's Comet was last seen in 1986 and will return in 2061!"""},
    
    {"input": "Andromeda Galaxy", "output": """The Andromeda Galaxy is the closest spiral galaxy to the Milky Way, located about 2.5 million light-years from Earth. It is the largest galaxy in our local group, containing around one trillion stars. Andromeda is on a collision course with the Milky Way, expected to merge in about 4.5 billion years. Fun fact: Andromeda is visible to the naked eye from Earth in the Northern Hemisphere!"""},
    ]

    water_beings_examples = [
    {"input": "Great White Shark", "output": """The great white shark is one of the most feared predators in the ocean, found in coastal waters around the world. They are carnivores, primarily feeding on fish, seals, and other marine mammals. Great whites are known for their powerful jaws and sharp teeth. Fun fact: Great white sharks can detect a drop of blood in 25 gallons of water and can sense tiny electrical signals from living creatures!"""},
    
    {"input": "Blue Whale", "output": """The blue whale is the largest animal ever known to have existed, found in oceans worldwide. Despite their massive size, they feed primarily on tiny krill, consuming up to 4 tons of them daily. Blue whales communicate through low-frequency calls that can be heard for hundreds of miles. Fun fact: A blue whale’s heart is as large as a small car and can weigh up to 1,300 pounds!"""},
    
    {"input": "Jellyfish", "output": """Jellyfish are ancient marine creatures found in oceans all over the world. They are carnivores, feeding on small fish and plankton using their stinging tentacles. Jellyfish are known for their gelatinous bodies and lack of brains or bones. Fun fact: Some jellyfish are bioluminescent, meaning they can produce their own light in the dark depths of the ocean!"""},
    ]

    plant_examples = [
    {"input": "Rose", "output": """The rose, often called the queen of flowers, is known for its beauty and fragrance. Roses are found worldwide and are cultivated in a variety of colors and sizes. They thrive in well-drained soil with plenty of sunlight. Roses are not only symbols of love but also have culinary uses in teas and jams. Fun fact: The rose is the national flower of the United States, the United Kingdom, and several other countries!"""},
    
    {"input": "Bamboo", "output": """Bamboo is a fast-growing grass that can be found in Asia, Africa, and the Americas. Known for its strength and flexibility, bamboo is used in construction, furniture, and even clothing. It grows incredibly fast, with some species shooting up over 3 feet in a single day. Fun fact: Bamboo is a crucial food source for pandas, making up 99% of their diet!"""},
    
    {"input": "Sunflower", "output": """Sunflowers are tall, bright flowers native to North America, known for their large, sun-tracking blooms. They thrive in full sun and well-drained soil, often growing over 10 feet tall. Sunflowers are not just beautiful; their seeds are harvested for oil and snacks. Fun fact: A sunflower's head can contain up to 2,000 seeds, and the plant can follow the sun across the sky, a behavior called heliotropism!"""},
    ]
    ...
    branches = RunnableBranch(
        ...
        (
            ...
            water_beings_final_prompt | model | StrOutputParser()  # Positive feedback chain
        ),
        (
            lambda x: "space_objects" in input_dict['type'],
            space_object_final_prompt | model | StrOutputParser()  # Positive feedback chain
        ),
